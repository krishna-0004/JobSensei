...
//   return (
//     // <section className=" overflow-y-auto h-screen m-4 mb-0">
...
//     //         <input name="name" value={profile.name || ''} onChange={handleInputChange} className="input border-2 border-gray-500 px-4 py-2 bg-white rounded-2xl" placeholder="Name" />
//     //         <input name="phone" value={profile.phone || ''} onChange={handleInputChange} className="input border-2 border-gray-500 px-4 py-2 bg-white rounded-2xl" placeholder="Phone" />
//     //         <input name="location" value={profile.location || ''} onChange={handleInputChange} className="input border-2 border-gray-500 px-4 py-2 bg-white rounded-2xl" placeholder="Location" />
//     //         <input name="bio" value={profile.bio || ''} onChange={handleInputChange} className="input border-2 border-gray-500 px-4 py-2 bg-white rounded-2xl" placeholder="Bio" />
//     //         <input name="gender" value={profile.gender || ''} onChange={handleInputChange} className="input border-2 border-gray-500 px-4 py-2 bg-white rounded-2xl" placeholder="Gender" />
//     //         <input name="dateOfBirth" value={profile.dateOfBirth || ''} onChange={handleInputChange} className="input border-2 border-gray-500 px-4 py-2 bg-white rounded-2xl" placeholder="Date of Birth" />
//     //         <input
//     //           name="skills"
//     //           value={(profile.skills || []).join(', ')}
//     //           onChange={(e) => setProfile((prev) => ({ ...prev, skills: e.target.value.split(',').map((s) => s.trim()) }))}
//     //           className="input border-2 border-gray-500 px-4 py-2 bg-white rounded-2xl"
...
//     //         </div>
//     //         {/* Education */}
//     //         <h4 className="text-lg  mt-4">Education</h4>
//     //         {(profile.education || []).map((edu, i) => (
//     //           <div key={i} className="border rounded-2xl p-3  mb-3 space-y-2 bg-white grid grid-cols-3 items-center gap-10">
//     //             <input
//     //               placeholder="Institution"
//     //               value={edu.institution}
//     //               onChange={(e) => handleNestedChange(e, i, 'education', 'institution')}
//     //               className="input outline-none border-b-1 py-2"
//     //             />
//     //             <input
//     //               placeholder="Degree"
//     //               value={edu.degree}
...
//     //               className="text-white bg-red-500 py-2 rounded-3xl text-sm"
//     //             >
//     //                Delete
//     //             </button>
//     //           </div>
...
//     //         <h4 className="text-lg  mt-4">Awards & Certifications</h4>
//     //         {(profile.awardsAndCertifications || []).map((award, i) => (
//     //           <div key={i} className="border p-3 rounded-2xl grid grid-cols-3 items-center gap-10 mb-3 space-y-2 bg-gray-50">
//     //             <input placeholder="Title" value={award.title} onChange={(e) => handleNestedChange(e, i, 'awardsAndCertifications', 'title')} className="input border-b-2 outline-0 py-2 border-gray-400" />
//     //             <input placeholder="Issuer" value={award.issuer} onChange={(e) => handleNestedChange(e, i, 'awardsAndCertifications', 'issuer')} className="input border-b-2 outline-0 py-2 border-gray-400" />
//     //             <input placeholder="Year" type="number" value={award.year} onChange={(e) => handleNestedChange(e, i, 'awardsAndCertifications', 'year')} className="input border-b-2 outline-0 py-2 border-gray-400" />
//     //             <input placeholder="Credential URL" value={award.credentialUrl} onChange={(e) => handleNestedChange(e, i, 'awardsAndCertifications', 'credentialUrl')} className="input border-b-2 outline-0 py-2 border-gray-400" />
...
//     //         {/* Projects */}
//     //         <h4 className="text-lg  mt-4">Projects</h4>
...
//     //             </div>
//     //             <div className="grid grid-cols-3 items-center">
//     //               <p className="text-lg  text-gray-800"><b>Gender :</b> {profile.gender}</p>
...
//     //           {/* Skills Section */}
//     //           <div className="mb-8">
//     //             <p className="text-xl  text-gray-800"><b>Skills:</b> {(profile.skills || []).join(', ')}</p>
//     //           </div>
